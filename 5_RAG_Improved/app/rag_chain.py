...
postgres_memory_url = f"postgresql+psycopg://{db_user}:{db_password}@{db_host}:{db_port}/pdf_rag_history"
...
print(f"Esta es la standalone question: {standalone_question_prompt}")
